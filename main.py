...
if __name__ == '__main__':
    ...
    # ['danielnaroditsky', 'ohmylands', 'chuckmoulton', 'danlsn', 'malikidesc', 'gothamchess', 'hikaru',
    # 'ChessBrah', 'KVNB', 'annacramling', 'ludwig']
    # ['venancioortega', 'agadmator', 'penguingm1', 'danielnaroditsky', 'ohmylands', 'chuckmoulton', 'danlsn', 'malikidesc', 'gothamchess', 'hikaru',
    #                     'ChessBrah', 'KVNB', 'annacramling', 'ludwig','GMCanty', 'GMHess', 'Anna_Chess', 'SamCopeland',
    #                    'AlexandraBotez', 'GMBenjaminFinegold', 'QTCinderella', 'MichelleKhare', 'DanielRensch',
    #                    'bobbybojanglles', 'viditchess', 'GMHikaruOnTwitch','erichansen', 'anishgiri', 'samayraina',
    #                    'firouzja2003']
    # for player in ['Lud-Skywalker', 'mrbeastreal', 'rubiuszx', 'mobamba604', 'moistCr1tikal', 'xQcow', 'RainnWilson',
    #     #                'sardochesti', 'neeko', 'Benjyfishy1', 'codemikoattwitch', 'turbofisto', 'bobbyhall', 'dnegs',
    #     #                'TheMyth', 'pokimane']:
    for player in ['knvb']:
        insert_player_profile(player)
        insert_archive_urls(player)
        insert_player_games(player)
